  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <svg viewBox="0 0 500 500" className="w-[85%] max-w-[420px] relative z-10 drop-shadow-2xl" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="200" y="90" textAnchor="middle" fill="rgba(14,165,233,0.8)" fontSize="13" fontWeight="700" fontFamily="Inter, sans-serif">CRM Dashboard</text>
        ...
        <g opacity="0.9">
          ...
          <text x="125" y="148" textAnchor="middle" fill="#0ea5e9" fontSize="10" fontWeight="600" fontFamily="Inter, sans-serif">Leads</text>
          <text x="125" y="168" textAnchor="middle" fill="#0c4a6e" fontSize="18" fontWeight="800" fontFamily="Inter, sans-serif">2,847</text>
          ...
          <text x="245" y="148" textAnchor="middle" fill="#14b8a6" fontSize="10" fontWeight="600" fontFamily="Inter, sans-serif">Deals</text>
          <text x="245" y="168" textAnchor="middle" fill="#0c4a6e" fontSize="18" fontWeight="800" fontFamily="Inter, sans-serif">₹42L</text>
          ...
          <text x="365" y="148" textAnchor="middle" fill="#8b5cf6" fontSize="10" fontWeight="600" fontFamily="Inter, sans-serif">Conv.</text>
          <text x="365" y="168" textAnchor="middle" fill="#0c4a6e" fontSize="18" fontWeight="800" fontFamily="Inter, sans-serif">68%</text>
        </g>
        ...
        <g transform="translate(75, 195)">
          ...
          <text x="90" y="18" textAnchor="middle" fill="#64748b" fontSize="9" fontWeight="600" fontFamily="Inter, sans-serif">Revenue Trend</text>
          {/* Chart bars */}
          {[
        ...
        <g transform="translate(275, 195)">
          ...
          <text x="70" y="18" textAnchor="middle" fill="#64748b" fontSize="9" fontWeight="600" fontFamily="Inter, sans-serif">Pipeline</text>
          {/* Funnel stages */}
          {[
            ...
            <g key={label}>
              ...
              <text x="70" y={y + 12} textAnchor="middle" fill="white" fontSize="8" fontWeight="600" fontFamily="Inter, sans-serif">{label}</text>
            </g>
          ))}
        </g>
        ...
        <g>
          ...
          <text x="420" y="85" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Inter, sans-serif">5</text>
        </g>
        ...
        <g transform="translate(100, 335)" opacity="0.8">
          ...
          <text x="0" y="5" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Inter, sans-serif">S</text>
          <circle cx="28" cy="0" r="15" fill="#14b8a6" opacity="0.8" />
          <text x="28" y="5" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Inter, sans-serif">A</text>
          <circle cx="56" cy="0" r="15" fill="#8b5cf6" opacity="0.8" />
          <text x="56" y="5" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Inter, sans-serif">M</text>
          ...
          <text x="84" y="5" textAnchor="middle" fill="#0ea5e9" fontSize="14" fontWeight="400" fontFamily="Inter, sans-serif">+</text>
        </g>
      </svg>
