...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    tagline: 'Send & receive WhatsApp messages via Kriscel WA',
    description: 'Connect your Kriscel WA instance to send and receive WhatsApp messages directly from NexaCRM. Create a session and link your WhatsApp number via QR code.',
    features: ['Two-way messaging', 'Text & media messages', 'Bulk messaging', 'Session management'],
    color: '#25D366', bg: '#F0FFF4',
    authType: 'apikey',
    docsUrl: 'https://kriscelwa.187.127.149.196.nip.io',
    fields: [
      { key: 'apiKey',      label: 'API Key',                  placeholder: 'owa_k1_...', secret: true, hint: 'From Kriscel WA → API Access page' },
      { key: 'sessionId',   label: 'Session ID',               placeholder: 'my-crm-session', hint: 'Create a session in Kriscel WA → Sessions' },
      { key: 'apiUrl',      label: 'API Base URL',             placeholder: 'https://kriscelwa.187.127.149.196.nip.io/api', hint: 'Leave empty to use default Kriscel WA URL' },
