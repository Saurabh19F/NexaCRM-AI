...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'adminNotificationPhone', label: 'Admin WhatsApp Numbers for Notifications (up to 5)', placeholder: '918985419420, 919876543210', hint: 'Comma-separated WhatsApp numbers (up to 5) to receive new lead alerts + call intelligence reports. Falls back to tenant contact phone if empty.' },
  ...
  },
  {
    ...
    tagline: 'Power all AI features with OpenAI GPT',
    ...
    color: '#10A37F', bg: '#F0FDF9',
    authType: 'apikey',
    docsUrl: 'https://platform.openai.com/docs/api-reference/chat',
    fields: [
      { key: 'apiKey', label: 'OpenAI API Key', placeholder: 'sk-...', secret: true, hint: 'Create one at platform.openai.com/api-keys' },
      { key: 'model',  label: 'Model',       placeholder: 'gpt-4o-mini', hint: 'Recommended: gpt-4o-mini' },
    ],
    Icon: Sparkles,
  },
]
