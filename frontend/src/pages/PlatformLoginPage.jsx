  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <svg viewBox="0 0 500 500" className="w-[85%] max-w-[420px] relative z-10 drop-shadow-2xl" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="280" y="80" textAnchor="middle" fill="rgba(14,165,233,0.8)" fontSize="12" fontWeight="700" fontFamily="Roboto, sans-serif">Platform Admin Console</text>

        {/* Company tiles grid */}
        <g transform="translate(85, 115)">
          <text x="0" y="12" fill="#64748b" fontSize="10" fontWeight="600" fontFamily="Roboto, sans-serif">Companies</text>
          {[
            ...
            <g key={label}>
              ...
              <text x={x + 18} y={y + 25} textAnchor="middle" fill="white" fontSize="9" fontWeight="700" fontFamily="Roboto, sans-serif">
                {label.charAt(0)}
              </text>
              <text x={x + 38} y={y + 17} fill="#334155" fontSize="9" fontWeight="600" fontFamily="Roboto, sans-serif">{label}</text>
              <text x={x + 38} y={y + 30} fill="#94a3b8" fontSize="8" fontFamily="Roboto, sans-serif">{users} users</text>
            </g>
          ))}
        </g>
        ...
        <g transform="translate(85, 250)">
          <text x="0" y="12" fill="#64748b" fontSize="10" fontWeight="600" fontFamily="Roboto, sans-serif">Subscription Health</text>
          {[
            ...
            <g key={label}>
              ...
              <text x="6" y={y + 13} fill="#334155" fontSize="8" fontWeight="600" fontFamily="Roboto, sans-serif">{label}</text>
              <text x="320" y={y + 13} textAnchor="end" fill="#64748b" fontSize="8" fontWeight="600" fontFamily="Roboto, sans-serif">{pct}</text>
            </g>
          ))}
        </g>
        ...
        <text x="410" y="74" textAnchor="middle" fill="white" fontSize="10" fontWeight="700" fontFamily="Roboto, sans-serif">3</text>
        ...
        <g transform="translate(130, 355)" opacity="0.85">
          ...
          <text x="0" y="5" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Roboto, sans-serif">A</text>
          <circle cx="32" cy="0" r="14" fill="#14b8a6" />
          <text x="32" y="5" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="Roboto, sans-serif">P</text>
          <text x="60" y="5" fill="#64748b" fontSize="10" fontFamily="Roboto, sans-serif">2 Platform Admins</text>
        </g>
      </svg>
      ...
      <div className="hidden lg:flex flex-col w-1/2 relative">
        ...
        <div className="flex h-full items-center px-8">
          <div className="max-w-md space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-950">Simple oversight for every workspace.</h1>
            <p className="text-sm leading-6 text-slate-600">
              Review companies, users, subscriptions, and security from a restrained admin surface.
            </p>
          </div>
        </div>
      </div>
