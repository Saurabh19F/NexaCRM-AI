...
public class InvoiceService {
    ...
    public InvoiceDTO findById(String id) {
        return invoiceRepository.findByIdAndTenantIdAndDeletedFalse(id, DEFAULT_TENANT)
            .map(this::toDTO)
    ...
    public InvoiceDTO update(String id, InvoiceDTO dto) {
        Invoice invoice = invoiceRepository.findByIdAndTenantIdAndDeletedFalse(id, DEFAULT_TENANT)
            .orElseThrow(() -> new ResourceNotFoundException("Invoice not found: " + id));
        ...
        if (dto.getCustomerId() != null) {
            if (dto.getCustomerId().isBlank()) {
                ...
                customerRepository.findByIdAndTenantIdAndDeletedFalse(dto.getCustomerId(), DEFAULT_TENANT)
        ...
        if (dto.getDealId() != null) {
            if (dto.getDealId().isBlank()) {
                ...
                dealRepository.findByIdAndTenantIdAndDeletedFalse(dto.getDealId(), DEFAULT_TENANT)
